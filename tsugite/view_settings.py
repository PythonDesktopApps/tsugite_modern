...
class ViewSettings:
    ...
    # not used
    def set_absolute_joint_opening_distance(self, val):
        self.open_ratio = val / 100

    def update_rotation_xy(self, x: int, y: int) -> None:
    ...
    def start_rotation_xy(self, x: int, y: int) -> None:
        self.xstart, self.ystart = x, y
        self.dragged = True
        self.xrot0 = self.xrot
        self.yrot0 = self.yrot

    def standardize_rotation(self) -> None:
        step = math.pi / 12
